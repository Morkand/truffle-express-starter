...
contract("DryadToken", function (accounts) {
  var tokenInstance;
  ...
  it("initializes the contract with the correct values", function () {
    return DryadToken.deployed()
      ...
      .then(function (name) {
        assert.equal(name, "Dryad", "has the correct name");
        return tokenInstance.symbol();
      })
      .then(function (symbol) {
        assert.equal(symbol, "DYD", "has the correct symbol");
        return tokenInstance.standard();
      })
      .then(function (standard) {
        assert.equal(standard, "Dryad v1.0", "has the correct standard");
      });
  });
